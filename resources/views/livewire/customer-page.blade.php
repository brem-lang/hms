            ...
            <div>
                ...
                <div class="row gallery-item">
                    ...
                    <div class="functionhall-carousel owl-carousel p-4">
                        <div class="item">
                            <img src="img/functionhall/fn1.jpg" alt="Function Hall Image 1"
                                style="width: 100%; height: auto;">
                        </div>
                        <div class="item">
                            <img src="img/functionhall/fn2.jpg" alt="Function Hall Image 2"
                                style="width: 100%; height: auto;">
                        </div>
                        <div class="item">
                            <img src="img/functionhall/fn3.jpg" alt="Function Hall Image 3"
                                style="width: 100%; height: auto;">
                        </div>
                        <div class="item">
                            <img src="img/functionhall/fn4.jpg" alt="Function Hall Image 4"
                                style="width: 100%; height: auto;">
                        </div>
                        <div class="item">
                            <img src="img/functionhall/fn5.jpg" alt="Function Hall Image 5"
                                style="width: 100%; height: auto;">
                        </div>
                    </div>
                    @else
                    <div class="suite-images-carousel owl-carousel p-4">
                        ...
                        <div class="item">
                            <img src="{{ asset('suite-photo/' . $image) }}" alt="Suite Image"
                                style="width: 100%; height: auto;">
                        </div>
                        @endforeach
                    </div>
        ...
        <div x-show="activeTab === 'about'" x-cloak x-transition>
            <div>
                ...
                <p class="sample-text">
                    ...
                    "Our Standard Suite offers a perfect blend of comfort and elegance — featuring a cozy bed, modern amenities, and a calming atmosphere ideal for both rest and relaxation."
                    @endif

                    @if ($selectedRoom['name'] == 'Deluxe Suite')
                    "Our Deluxe Suite offers a luxurious experience with a spacious layout, top-of-the-line amenities, and a comfortable atmosphere that will make you feel at home."
                    @endif

                    @if ($selectedRoom['name'] == 'Executive Suite')
                    "Our Executive Suite is the perfect choice for those who want a spacious and elegant space with top-of-the-line amenities."
                    @endif

                    @if ($selectedRoom['name'] == 'Function Hall')
                    "Our Function Hall is a versatile space designed for events and gatherings, equipped with modern facilities to ensure your event is a success."
                    @endif
                </p>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        @php
                        $roomKey = match($selectedRoom['name']) {
                        'Standard Suite' => 'standard',
                        'Deluxe Suite' => 'deluxe',
                        'Executive Suite' => 'executive',
                        'Function Hall' => 'functionHall',
                        default => null
                        };
                        @endphp

                        @if($roomKey && isset($record[$roomKey]['items']))
                        @foreach ($record[$roomKey]['items'] as $item)
                ...
                <div class="mt-4 p-4 rounded-lg bg-gray-50 border border-gray-200 dark:bg-white/5 dark:border-white/10">
                    <h3 class="text-heading mb-3" style="font-size: 1.1em;">Booking Terms & Policies</h3>
                    <div style="font-size: 0.9em; line-height: 1.6;">
                        <ul class="unordered-list">
                            @if ($selectedRoom['name'] == 'Function Hall')
                            <li><strong>Down Payment:</strong> A non-refundable 50% down payment is required for confirmation.</li>
                            <li><strong>Full Payment:</strong> Balance is due 7 days prior to the event date.</li>
                            <li><strong>Overtime:</strong> Charges of ₱ 1,000 per hour apply.</li>
                            @endif

                            {{-- Kini ang imong gidugang nga rules --}}
                            <li><strong>Rebooking:</strong> Allowed up to 1 day before the scheduled date.</li>
                            <li><strong>Schedule Change:</strong> Permitted one (1) time only per booking.</li>
                            <li><strong>Liability:</strong> The client is fully liable for any damages to the property.</li>
                        </ul>
                        <p class="mt-2 font-bold text-primary-600">Please read the full contract before proceeding.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="whole-wrap">
        <div class="container box_1170">
            ...
            {{-- @switch($this->selectedRoom['name'])
                    @case('Standard Suite')
                        <div class="text-right"> {{ 7 - $record['standardOccupied'] }} Available Room(s)
        </div>

            ...
            <div class="mb-5">
                ...
                <div class="space-y-6">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-2 py-3 text-gray-900 dark:text-white w-1/4">
                                            {{ $booking->user->name }} / {{ $booking->user->contact_number }}
                                        </td>
                    ...
                    <div class="md:grid md:grid-cols-3 gap-6">
                        ...
                        <x-filament::section class="col-span-2" collapsible collapsed>
                            <x-slot name="heading">
                                Financial Summary (₱)
                            </x-slot>
                        ...
                        <x-filament::section class="text-center mt-4" collapsible collapsed>
                            <x-slot name="heading">
                                Scan to Pay (GCash)
                            </x-slot>

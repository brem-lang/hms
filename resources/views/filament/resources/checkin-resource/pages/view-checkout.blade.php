                                        ...
                                        <table
                                            ...
                                            <thead class="bg-gray-50 dark:bg-gray-800">
                                                <tr>
                                                    ...
                                                    <th class="p-3 text-right font-medium">Quantity</th>
                                            ...
                                            <tbody class="divide-y">
                                                @foreach ($record->additional_charges as $charge)
                                                    @php
                                                        $chargeModel = \App\Models\Charge::find($charge['name']);
                                                    @endphp
                                                    <tr>
                                        ...
                                        <table
                                            ...
                                            <tbody class="divide-y">
                                                @foreach ($record->food_charges as $charge)
                                                    @php
                                                        $foodModel = \App\Models\Food::find($charge['name']);
                                                    @endphp
                                                    <tr>

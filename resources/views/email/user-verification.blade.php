...
<body width="100%"
    ...
    <center style="width: 100%; background-color: #f1f1f1;">
        ...
        <h1 style="text-align: center;"><a href="{{ config('app.url') }}">Millenium Suites</a></h1>
                ...
                <tr>
                    <td valign="middle" class="hero bg_white" style="padding: 20px">
                        ...
                        <div style="text-align: center; margin: 30px 0;">
                            <a href="{{ $details['verification_url'] }}" 
                               style="background: #004271; color: #ffffff; padding: 12px 30px; text-decoration: none; border-radius: 5px; display: inline-block; font-weight: 600;">
                                Verify Email Address
                            </a>
                        </div>

                        <p style="margin-top: 20px; font-size: 14px; color: rgba(0, 0, 0, .6);">
                            If the button doesn't work, copy and paste this link into your browser:
                        </p>
                        <p style="margin: 10px 0; font-size: 12px; word-break: break-all; color: #004271;">
                            {{ $details['verification_url'] }}
                        </p>

                        <p style="margin-bottom: 0; margin-top: 30px;"><b>Regards:</b></p>
                        <p style="margin: 0">Millenium Suites</p>

                        <hr style="border-top: 1px solid rgb(207, 207, 207); margin-top: 30px;">
